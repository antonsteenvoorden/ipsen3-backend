 ...
 */
public class GroothandelBestellingKnop implements Knop {
    private String knopTekst = "Groothandel bestelling";
    private GroothandelBestellingHandler k;

    public GroothandelBestellingKnop(GroothandelBestellingHandler k) {
        this.k = k;
    }
    ...
    public void onClick() {
        ...
        k.groothandelBestellingClicked();
    }
