...
/**
 * Deze klas is de GUI van het versturen van een herinnering e-mail.
 *
 * @author dennis
 */
public class HerinneringMailView {
    private Stage stage;
    private Scene scene;
     ...
     */
    public HerinneringMailView(MailController mailController) {
    ...
    private void display() {
        ...
        remove.setOnAction(e -> {
            if (ontvangersSelectie.getSelectionModel().isEmpty() == false) {
        ...
        verzenden.setOnAction(e -> {
            mailController.sendHerinneringMail();
            new HomeView();
        });
        ...
        FilteredList<Klant> filterData = new FilteredList<Klant>(mailController.getGeenSelectieLijst());
        ...
        sortedData.comparatorProperty().bind(geenOntvangersSelectie.comparatorProperty());

        // 5. Add sorted (and filtered) data to the table.
        geenOntvangersSelectie.setItems(sortedData);
        ...
        leftBox.getChildren().addAll(geenSelectie, zoekBox, geenOntvangersSelectie, add);
        rightBox.getChildren().addAll(selectie, ontvangersSelectie, remove);
