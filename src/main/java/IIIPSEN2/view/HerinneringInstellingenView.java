 ...
 * @author Anton
 */
public class HerinneringInstellingenView {
    private Stage stage;
    private Scene scene;
    ...
    public HerinneringInstellingenView(SettingsController settingsController) {
        stage = new Stage();
    ...
    private void display() {
        ...
        body = new TextArea();
        body.setPromptText("bijvoorbeeld: Vergeet u niet dat het wijnfestijn bijna plaatsvindt! ");

        tf_aanhef.setText(prefs.get("herinneringMail_aanhef", ""));
        tf_onderwerp.setText(prefs.get("herinneringMail_onderwerp", ""));
        body.setText(prefs.get("herinneringMail_body", ""));
    ...
    private void opslaan() {
        settingsController.saveHerinneringMail(tf_onderwerp.getText(), tf_aanhef.getText().toString(), body.getText()
                .toString());
        stage.close();
    }
