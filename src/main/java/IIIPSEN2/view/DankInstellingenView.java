 ...
 * @author Anton
 */
public class DankInstellingenView {
    private Stage stage;
    private Scene scene;
    ...
    public DankInstellingenView(SettingsController settingsController) {
        stage = new Stage();
    ...
    private void display() {
        ...
        body = new TextArea();
        body.setPromptText("bijvoorbeeld: Hierbij uw factuur .. \n De Lionsclub \n telefoon etc..");

        tf_onderwerp.setText(prefs.get("dankMail_onderwerp", ""));
        tf_aanhef.setText(prefs.get("dankMail_aanhef", ""));
        body.setText(prefs.get("dankMail_body", ""));
    ...
    private void opslaan() {
        settingsController.saveDankMail(tf_onderwerp.getText(), tf_aanhef.getText().toString(), body.getText()
				.toString());
        stage.close();
    }
