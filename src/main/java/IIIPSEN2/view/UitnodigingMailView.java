...
/**
 * Deze klas is de GUI van het versturen van een uitnodiging e-mail.
 *
 * @author dennis
 */
public class UitnodigingMailView {
    private Stage stage;
    private Scene scene;

    private Button cancel, verzenden, add, remove, selecteerUitnodiging;
     ...
     */
    public UitnodigingMailView(MailController mailController) {
    ...
    private void display() {
        ...
        verzenden.setOnAction(e -> {
            mailController.sendUitnodigingMail();
            if (mailController.isRestart()) {
                mailController.reset();
                mailController.uitnodigingenClicked();
            } else {
                new HomeView();
            }
        });
        ...
        selecteerUitnodiging = new Button("selecteer uitnodiging bestand");
        selecteerUitnodiging.setOnAction(e -> {
            FileChooser fc = new FileChooser();
            fc.setTitle("kies de uitnoding die wordt meegestuurd als bijlage");
            File file = fc.showOpenDialog(stage);
            mailController.setUitnodiging(file);
        });
        ...
        leftBox.getChildren().addAll(geenSelectie, geenOntvangersSelectie, selecteerUitnodiging, add);
        rightBox.getChildren().addAll(selectie, zoekBox, ontvangersSelectie, remove);
