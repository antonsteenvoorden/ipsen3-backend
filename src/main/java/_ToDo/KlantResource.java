...
//import model.Klant;
//import petersinspiratiepakket.actorius._View._View;
...
//
//    @GET
//    @JsonView(_View._View.Public.class)
//    @RolesAllowed("GUEST")
...
//    @JsonView(_View._View.Protected.class)
...
//    @GET
//    @Path("/me")
//    @JsonView(_View._View.Private.class)
